...
public class SidebarSection extends JPanel {
	...
	public SidebarSection(SideBar owner, 
		...
		RoundedBorder roundedBorder =  new RoundedBorder(Color.RED);
		...
		arrowPanel = new ArrowPanel(SwingConstants.RIGHT,Color.GREEN,new Color(0x0, true),new Color(0x0, true),Color.BLUE);
		arrowPanel.setBackground(Color.MAGENTA);
		...
		titleComponent.setForeground(Color.MAGENTA);
