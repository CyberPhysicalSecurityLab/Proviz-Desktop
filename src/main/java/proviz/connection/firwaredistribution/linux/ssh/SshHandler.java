package proviz.connection.firwaredistribution.linux.ssh;
...
//        System.out.println(properties.getPortNumber());
...
//        sftp = new SftpTransfer(user, host, 22, pass, knowHostFile);
//        exec = new SshExec(user, host, 22, pass, knowHostFile);

        sftp = new SftpTransfer(user, host, port, pass, knowHostFile,identityfile);
        exec = new SshExec(user, host, port, pass, knowHostFile,identityfile);
    }
...
//        String command="echo 'fullStop' > ~/.proviz/pipes/control_pipe";
    ...
    public static void writeProperties(){
        ...
        properties.setBtSspUuid("8848"); // bl spp uuid, used to find service
        properties.setBtObexUuid("");
        // send settings to file
        //todo burak alttaki comment a bir bak
...
//            sshHandler.connect();
//
////            sshHandler.sendStopAppCommand();
////            try {
////                sleep(1000);
////            } catch (InterruptedException e) {
////                e.printStackTrace();
////            }
////            sshHandler.sendStartAppCommand();
//
